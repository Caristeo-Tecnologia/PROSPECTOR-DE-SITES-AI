...
```
e reinicie o app — a versão certa é a **2.2.2** (confira em Gerenciar plugins). Se não subir: desinstale o plugin → remova o marketplace → feche o app → adicione e instale de novo. A partir da 2.2.2 a atualização é automática (autoUpdate ativado).
